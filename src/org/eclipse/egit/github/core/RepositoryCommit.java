...
public class RepositoryCommit implements Serializable, Comparable<RepositoryCommit> {
	...
	@Override
	public int compareTo(RepositoryCommit another) {
		//return another.getAuthor().getName().compareTo(this.author.getName());
		return another.commit.getAuthor().getName().compareTo(this.commit.getAuthor().getName());
		//return another.commit.getMessage().compareTo(this.commit.getMessage());
	}
}
